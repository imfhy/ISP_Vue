...
import { GetTableData, AddData, ModifyData, DeleteData, HandleDelete, ExportData, ImportData } from '@/api/dayconfig/Customer'
...
<style lang="scss" scoped>
  @import '../../assets/css/dayconfig/Customer.scss';
</style>
<style>
.btnDanger{
