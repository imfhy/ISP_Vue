...
import { GetTableData, AddData, ModifyData, DeleteData, HandleDelete, ExportData, ImportData } from '@/api/dayconfig/Summary'
...
<style lang="scss" scoped>
  @import '../../assets/css/dayconfig/Summary.scss';
</style>
<style>
.btnDanger{
